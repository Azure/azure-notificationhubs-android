...
class CustomConnectionString {
    ...
    CustomConnectionString(String endpoint, String sharedAccessKeyName, String sharedAccessKey) {
    ...
    public static CustomConnectionString parse(String connectionString) {
        ...
        CustomConnectionString result = new CustomConnectionString(Endpoint, SharedAccessKeyName, SharedAccessKey);
        return result;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CustomConnectionString)) {
            return false;
        }

        CustomConnectionString cast = (CustomConnectionString) o;
