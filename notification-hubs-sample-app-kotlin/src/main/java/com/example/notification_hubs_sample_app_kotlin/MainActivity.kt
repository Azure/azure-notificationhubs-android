...
import com.example.notification_hubs_sample_app_kotlin.ui.main.SectionsPagerAdapter
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NotificationHub.addTag("userAgent:com.example.notification_hubs_sample_app_kotlin:0.1.0")
